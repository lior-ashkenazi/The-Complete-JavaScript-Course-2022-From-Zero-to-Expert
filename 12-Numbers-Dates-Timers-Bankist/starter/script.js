...
const formatMovementDate = function (date, locale) {
    ...
    else if (7 <= dayPassed && dayPassed < 14) return "A week ago";
    else if (14 <= dayPassed && dayPassed < 21) return "2 weeks ago";
...
const displayMovements = function (acc, sort = false) {
    ...
    movs.forEach(function (mov, i) {
        ...
        const displayDate = formatMovementDate(new Date(acc.movementsDates[i]), acc.locale);
...
btnClose.addEventListener('click', function (e) {
    ...
    if (inputCloseUsername.value === curAcc.username &&
...
console.log('HE: ', new Intl.NumberFormat('he-IL', options).format(num));
